...
def modificar_excel_xlsm(ruta_excel, texto_celda):
    ...
    try:
        ...
        wb.Save()
        wb.Close(False)
        print(f"Archivo modificado: {ruta_excel_absoluta}, nuevo valor en B5: {texto_celda}")
    ...
    for carpeta_raiz, subcarpetas, archivos in os.walk(carpeta):
        ...
        for archivo in archivos:
            ...
            for archivo_buscar in archivos_buscar:
                ...
                if archivo.lower().startswith(archivo_buscar.lower()) and archivo.lower().endswith('.xlsm'):
                    ...
                    print(f"Archivo Excel (.xlsm) encontrado y modificado: {ruta_archivo_excel}")
    ...
    for carpeta_raiz, subcarpetas, archivos in os.walk(ruta_base):
        ...
        if os.path.basename(carpeta_raiz).startswith("056314"):
            ...
            if digitos_carpeta:
                ...
                archivos_buscar = [
                    "00IndiceElectronicoC01", "00IndiceElectronicoC02",
                    "00IndiceElectronicoC03", "00IndiceElectronicoC04",
                    "00IndiceElectronicoC05"
                ]
                
                # Llama a la función para buscar los archivos dentro de esta carpeta y sus subcarpetas
                buscar_archivos_en_subcarpetas(carpeta_raiz, archivos_buscar, digitos_carpeta)
