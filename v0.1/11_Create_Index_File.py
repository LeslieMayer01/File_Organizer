                    ...
                    for sub_dir in sub_dirs:
                        ...
                        if sub_dir.startswith("C0"):
                            ...
                            for archivo in archivos:
                                ...
                                if (
                                    os.path.isfile(archivo_path)
                                    and os.path.getsize(archivo_path) == 0
                                ):
                                    print(
                                        f"=> Carpeta Omitida: Archivo vacío encontrado"
                                    )
                                    print("=> Ruta: " + target_folder)
                                    carpetas_no_conformes.append(
                                        {
                            ...
                            for archivo in archivos:
                                ...
                                if archivo.endswith(".pdf"):
                                    try:
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Archivo PDF requiere contraseña o tiene error de acceso"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"Error al procesar el archivo {archivo}: {e}"
                                        )
                                        carpetas_no_conformes.append(
                                            {
                                                "Archivo Inválido": archivo,
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Archivo PDF no desencriptado encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Error al leer archivo PDF encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Permiso denegado para el archivo encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Error: Archivo PDF no tiene un objeto raíz válido: {e}"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                            ...
                            for archivo in archivos:
                                archivo_path = os.path.join(target_folder, archivo)
                                if archivo.endswith(".xlsx") or archivo.endswith(
                                    ".xlsm"
                                ):
                                    try:
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Archivo Excel inválido encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                            ...
                            for archivo in archivos:
                                ...
                                if archivo.endswith(".docx"):
                                    try:
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Archivo Word dañado o no válido encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Permiso denegado para el archivo de Word encontrado"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                                        ...
                                        print(
                                            f"=> Carpeta Omitida: Error inesperado al leer archivo de Word: {e}"
                                        )
                                        print("=> Ruta: " + target_folder)
                                        carpetas_no_conformes.append(
                                            {
                            ...
                            for archivo in archivos:
                                if validar_prefijo_numerico(archivo) == False:
                                    print(
                                        f"=> Carpeta Omitida: Archivo sin prefijo numérico encontrado"
                                    )
                                    print("=> Ruta: " + target_folder)
                                    carpetas_no_conformes.append(
                                        {
...
if __name__ == "__main__":
    ...
    root_folder = os.path.join(
        current_dir,
        r"D:\OneDrive\OneDrive - Consejo Superior de la Judicatura\01. EXPEDIENTES DE PROCESOS JUDICIALES\CONTENCIOSOS DE MINIMA Y MENOR CUANTIA CIVIL\VIGENTES\2025",
    )

    excel_ruta_error = "./reports/11_" + añadir_fecha_y_hora_al_nombre(
        "_Create_Index_File.xlsx"
    )
