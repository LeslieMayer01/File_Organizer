...
def generar_reporte_carpeta_faltante(ruta_base, reporte_excel):
    ...
    for dirpath, dirnames, filenames in os.walk(ruta_base):
        ...
        if nombre_carpeta.startswith('056314'):
            ...
            if os.path.exists(ruta_primera_instancia) and not os.path.exists(ruta_c01_principal):
...
reporte_excel = "./reports/09_"+ añadir_fecha_y_hora_al_nombre("Verify_Folder_C01Principal.xlsx")
