...
def obtener_archivos(directorio):
    ...
    for root, _, files in os.walk(directorio):
        for file in files:
            ...
            if 'zcontroldepagos' in file.lower() or '00indiceelectronico' in file.lower():
                continue
...
def procesar_archivos(archivos):
    ...
    for archivo in archivos:
        ...
        nombre_sin_extension, extension = os.path.splitext(nombre_actual)  # Separar nombre y extensión
