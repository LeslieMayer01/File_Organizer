...
def mover_archivos_056314(ruta_base, reporte_excel):
    ...
    for dirpath, dirnames, filenames in os.walk(ruta_base):
        ...
        if nombre_carpeta.startswith('056314'):
            ...
            ruta_c01_principal = os.path.join(dirpath, '01PrimeraInstancia', 'C01Principal')
            ruta_c04_depositos = os.path.join(dirpath, '01PrimeraInstancia', 'C04DepositosJudiciales')
            ...
            if os.path.exists(ruta_c01_principal):
                ...
                for archivo in os.listdir(ruta_c01_principal):
                    ...
                    if any(substring in archivo.lower() for substring in ['deposito', 'titulo', 'controldepago']):
...
reporte_excel = "./reports/08_"+ añadir_fecha_y_hora_al_nombre("Move_Files_Into_C04DepositosJudiciales.xlsx")
